...
## Write Excel Sheets for Rushali to Look At (Normalized)

```{r foot1w}
library("xlsx")
write.xlsx(x = foot1_SS2,
           file = "./dat_comp/foot1_compounds_norm.xlsx",
           sheetName = "SS2",
           col.names = TRUE,
           row.names = TRUE,
           append = FALSE)
...
write.xlsx(x = foot2_SS2,
           file = "./dat_comp/foot2_compounds_norm.xlsx",
           sheetName = "SS2",
           col.names = TRUE,
           row.names = TRUE,
           append = FALSE)
...
write.xlsx(x = foot3_SS5,
           file = "./dat_comp/foot3_compounds_norm.xlsx",
           sheetName = "SS5",
           col.names = TRUE,
           row.names = TRUE,
           append = FALSE)
...
write.xlsx(x = foot4_SS5,
           file = "./dat_comp/foot4_compounds_norm.xlsx",
           sheetName = "SS5",
           col.names = TRUE,
           row.names = TRUE,
           append = FALSE)
...
write.xlsx(x = foot5_SS2,
           file = "./dat_comp/foot5_compounds_norm.xlsx",
           sheetName = "SS2",
           col.names = TRUE,
           row.names = TRUE,
           append = FALSE)
